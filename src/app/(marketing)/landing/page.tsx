  ...
  return (
    <div style={{
      ...
      <div style={{ marginLeft: "auto" }}>
        <Link href="/" style={{ fontFamily: "var(--font-mono)", fontSize: 13, padding: "6px 14px", background: "var(--text-1)", color: "var(--bg)", borderRadius: 4, textDecoration: "none", letterSpacing: "-0.01em" }}>
          wypróbuj →
        </Link>
      </div>
    </div>
      ...
      <nav style={{ borderBottom: "1px solid var(--border)", position: "sticky", top: 0, background: "var(--bg)", zIndex: 50 }}>
        <div style={{ ...maxW, height: 52, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            ...
            <Link href="/" style={{ fontFamily: "var(--font-sans)", fontSize: 14, color: "var(--text-2)", textDecoration: "none" }}>
              zaloguj się →
            </Link>
          </div>
        </div>
      ...
      <section ref={heroRef} style={{ ...sectionPad, paddingTop: 100, paddingBottom: 100 }}>
        <div style={{ ...maxW, textAlign: "center" }}>
          ...
          <div style={{ marginTop: 36, display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
            <Link href="/" style={{ fontFamily: "var(--font-mono)", fontSize: 15, color: "var(--text-1)", textDecoration: "none", borderBottom: "1px solid var(--border)", paddingBottom: 1, transition: "border-color 150ms" }}>
              śledź to co miesiąc →
            </Link>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div style={{ background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 8, padding: "44px 48px", maxWidth: 400, width: "100%", boxShadow: "var(--shadow)" }}>
              ...
              <div style={{ marginTop: 32 }}>
                <Link href="/" style={{ display: "block", textAlign: "center", fontFamily: "var(--font-mono)", fontSize: 14, padding: "13px 0", background: "var(--text-1)", color: "var(--bg)", borderRadius: 4, textDecoration: "none", letterSpacing: "-0.01em" }}>
                  wypróbuj za darmo
                </Link>
              </div>
            </div>
        ...
        <div style={{ ...maxW, padding: "60px 32px 48px", display: "grid", gridTemplateColumns: "1fr auto", gap: 64, alignItems: "start" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 120px)", gap: 40 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <FooterLink href="/">Zarejestruj się</FooterLink>
                <FooterLink href="/">Zaloguj</FooterLink>
              </div>
            </div>
          </div>
        </div>
